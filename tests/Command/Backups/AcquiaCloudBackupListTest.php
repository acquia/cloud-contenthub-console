...
namespace Acquia\Console\Cloud\Tests\Command\Backups;

use Acquia\Console\Cloud\Command\Backups\AcquiaCloudBackupList;
...
/**
 * Class AcquiaCloudBackupListTest
 *
 * @coversDefaultClass \Acquia\Console\Cloud\Command\Backups\AcquiaCloudBackupList
 *
 * @group acquia-console-cloud
 *
 * @package Acquia\Console\Cloud\Tests\Command\Backups
 */
class AcquiaCloudBackupListTest extends TestCase {
  ...
  public function testBackupList(array $load_all_value, string $expected) {
    ...
    $cmd = new AcquiaCloudBackupList($config_storage->reveal());
